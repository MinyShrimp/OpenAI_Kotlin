    ...
    inner class PostCreateModeration {
        ...
        inner class Normal {
            ...
            private fun validateModerationResponse(
                ...
                Assertions.assertThat(moderationResponse.results?.get(0)?.flagged ?: false).isFalse
            }
        ...
        inner class Flagged {
            ...
            private fun validateModerationResponse(
                ...
                assertThat(moderationResponse.results).isInstanceOf(List::class.java)
                assertThat(moderationResponse.results).hasSize(1)
                Assertions.assertThat(moderationResponse.results?.get(0)?.flagged ?: false).isTrue
            }
